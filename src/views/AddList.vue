<template>
  <div>
    ...
    <div class="btn-row">
      <img class="btn" src="img/btn-cancel.png" @click="delFood"/>
      <img class="btn" src="img/btn-add.png" @click="addFood"/>
      <img class="btn" src="img/btn-fin.png" @click="addFoodToDB"/>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async addFoodToDB() {
      ...
      this.foods.forEach(food => {
        this.$axios.post("/cabinet/userId/add_item", {
          nameZh: food.nameZh,
          type: food.type,
